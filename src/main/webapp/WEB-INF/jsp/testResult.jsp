		...
		<tbody>
		  ...
		  <!--<td width="78%">Total number of questions</td>
			...
			<tr>
			  ...
			  <td width="7%">:</td>
			  <td width="15%"><span class="correctAnswerCount"><c:out value="${result.correctAnswerCount }"></c:out></span></td>
			</tr>
		
		  	<tr>
		  		<td>Number of answered questions</td>
			    <td>: </td>
			    <td><span class="answeredCount"><c:out value="${result.answeredCount }"></c:out></span></td>
			</tr>
			
	   		<tr>
			  <td>Number of unattempted questions</td>
			  <td>:</td>
			  <td><span class="unAnsweredCount"><c:out value="${result.unAnsweredCount }"></c:out></span></td>
			</tr>
			<tr>
				<td width="70%">Total Marks</td>
		  		<td width="5%">:</td>
		  		<td width="25%"><span class="totalMarks"><c:out value="${result.totalMarks }"></c:out></span></td>
			</tr>
	  	</tbody>
	  </table>
	</div>
	<div id="circle_main">  
		...
		<div id="circle">
			<table width="100%" border="0">
	  			<tbody>
	  				<tr>
						<td height="40" class="totalMarks"><c:out value="${result.totalMarks }"></c:out></td>
	  				</tr>
	   				<tr>
						<td style="border-top:solid 1px #999;" class="totalCount"><c:out value="${result.totalCount }"></c:out></td>
	  				</tr>
				</tbody>
			</table>
		</div>
