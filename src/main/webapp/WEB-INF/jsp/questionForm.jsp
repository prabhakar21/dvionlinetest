...
<div id="top-header" class="tb-main-header js-banner-height-offset" style="margin-top: 0px;background: #333;">
	<div class="form-group pull-left" style="margin-top:15px;">
		<span class="navbar-brand" style="text-decoration: none;"><h3 style="margin-top: 0px;"><a href="${pageContext.request.contextPath}/admin/registration" class="navbar-brand" style="text-decoration: none;"><c:out value="${username }"></c:out></a></h3></span>
...
<form action="${pageContext.request.contextPath}/createQuestion" method="post" id ="idForm" enctype="multipart/form-data">
...
<input type="hidden" class="form-control" id="testSetId" name="testSetId" value="${testSet.id}">
        ...
        <div class="clearfix practice-container-inner">
     		<div class="container-fluid practice-attempt-view">
       		 	<div  class="row">
		                ...
		                <a href="${pageContext.request.contextPath}/finish/${testSet.id}" class="btn btn-primary pull-right">Finished</a>
		                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		            </div>
	        	</div>
		    </div>
