...
public class TestSetController {
	...
	@RequestMapping(value = "/admin/create/testSet", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/admin/testSet", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/admin/testSet/updateTime", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/admin/testSet/delete", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/admin/isEnabled/testSet", method = RequestMethod.GET)
